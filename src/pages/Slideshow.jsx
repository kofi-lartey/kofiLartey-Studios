        ...
        return (
            <div className="fixed inset-0 bg-black flex items-center justify-center">
                <div className="text-center p-6">
                    <p className="text-white text-lg mb-4">No images to display</p>
                    <button 
                        onClick={handleClose}
                        className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg touch-target active:scale-95"
                    >
                        Go Back
                    </button>
                </div>
